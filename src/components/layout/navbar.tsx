      ...
      <div className="container flex w-full max-w-screen-2xl items-center">
        <div className="mr-4 hidden md:flex">
          <Link className="mr-6 flex items-center gap-2" href="/">
            ...
            <span className="font-bold tracking-tight text-foreground">OtakuNime</span>
          </Link>
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                    ...
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <div className="mb-2 mt-4 text-lg font-medium">Otakunimeee</div>
                    ...
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <div className="mb-2 mt-4 text-lg font-medium">Nimeegami</div>
                          <p className="text-sm leading-tight text-muted-foreground">
                    ...
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <div className="mb-2 mt-4 text-lg font-medium">Nimeeflix</div>
                          <p className="text-sm leading-tight text-muted-foreground">
        ...
        <div className="flex flex-1 items-center justify-between space-x-2 max-[640px]:justify-between sm:justify-between md:justify-end lg:justify-end xl:justify-end">
          ...
          <div className="flex items-center space-x-2 max-[640px]:justify-end sm:justify-end">
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              href="https://github.com/Lyntharx/otakunime-lyn"
            >
              <FaGithub />
            </Link>
            <Button
